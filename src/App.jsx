...
// Adopciones: el equipo pidió quitarlas de la página (22-ago-2026). La tabla
// `adopciones` y sus datos se conservan en la base, pero la interfaz ya no
// los muestra ni los escribe. Esta lista queda solo para que
// scripts/probar-esquema.mjs siga comprobando que la tabla existe.
    ...
    <div onClick={onCerrar} style={{
      ...
      <article onClick={(e) => e.stopPropagation()} style={{
        ...
        <p style={{ margin: "0 0 14px", fontSize: 13.5, color: T.tintaSuave, lineHeight: 1.5 }}>
          ...
          deshacen (aquí nada se borra: una ficha se oculta).
        </p>
